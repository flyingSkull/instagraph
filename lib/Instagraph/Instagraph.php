...
class Instagraph
{
    ...
    public function testConvert($input, $newName)
    {
        $this->execute("/usr/local/bin/convert $input $newName");
    }
...
//        return $output;
    ...
    public function process($filter)
    {
        ...
        printf('filter: ' . $filter . '<br>');
        printf('methode: ' . $method . '<br>');
